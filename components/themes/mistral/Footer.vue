<template>
    <footer class="mt-auto bg-white border-t border-black text-black pt-2">
        <div class="px-2 sm:px-6 lg:px-10">
          <div class="flex justify-between">
                ...
                <ul>
                    <li v-for="item in menu" :key="item.path" class="inline">
                        <NuxtLink
                            :key="item.path"
                            :to="item.path"
                            class="hover:text-gray-400 pe-2"
                        >
                            {{ item.name }}
                        </NuxtLink>
                    </li>
            ...
            <div
                class="inline mb-2 space-x-2 text-sm text-gray-500 dark:text-gray-400"
            >
                <span>© {{ config.name }} {{ new Date().getFullYear() }}</span>
                <span>•</span>
                <a href="https://docs.google.com/document/d/1wIBfNnJr3G19zIkc7fjeoZVdJZFhx2l4yDhjPws47iM/edit?usp=sharing">Privacy Policy</a>
                <span>•</span>
                <span>
                  Powered by
