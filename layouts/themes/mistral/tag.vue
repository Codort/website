  ...
  <main class="mt-14 taglist">
    <div class="mx-auto max-w-[1330px] md:p-4">
      <div class="">
        ...
        <div class="space-y-8">
          <div v-for="article in docs" :key="article._path" class="flex flex-col">
          ...
          <div class="flex items-center justify-center mt-10">
            <NuxtLink to="/archives"
              class="mt-2 border border-black hover:bg-slate-800 text-black font-semibold py-2 px-4 rounded">
              View all posts
            </NuxtLink>
          </div>
        </div>
